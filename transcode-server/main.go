// tessel-transcode — a tiny self-hosted companion for the Tessel Tizen TV app.
//
...
import (
	...
	"github.com/PatrickSt1991/tessel-tizen-tv/transcode-server/internal/smb"
	"github.com/PatrickSt1991/tessel-tizen-tv/transcode-server/internal/transcode"
	"github.com/PatrickSt1991/tessel-tizen-tv/transcode-server/internal/web"
)
...
func main() {
	...
	workDir := envStr("WORK_DIR", filepath.Join(os.TempDir(), "tessel-transcode"))
